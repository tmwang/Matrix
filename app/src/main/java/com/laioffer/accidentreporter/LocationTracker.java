...
/**
 * Location Tracker class to identifies current location (latitude, longitude)
 */
public class LocationTracker implements LocationListener {
    ...
    /**
     * Static function to fetch Json address format from specified latitude and longitude
     * @param lat latitude
