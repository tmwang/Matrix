package com.laioffer.accidentreporter.ViewSwitcher;
...
/**
 * GridView adapter to fit different types of traffic event
 */
public class MainGridViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MainGridViewAdapter(Context context, List<Item> items) {
